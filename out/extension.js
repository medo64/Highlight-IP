...
function activate(context) {
    ...
    function renderDocument(editor, configurationUpdate = false, ranges) {
        ...
        let ipNetworkDecorationType = (id in ipNetworkDecorationTypes) ? ipNetworkDecorationTypes[id] : null
        if ((ipNetworkDecorationType === null) || configurationUpdate) {
            ...
            ipNetworkDecorationType = vscode.window.createTextEditorDecorationType({ color: themeNetwork })
            ipNetworkDecorationTypes[id] =  ipNetworkDecorationType
            if (isDebug) { console.debug(new Date().getTime() + ' renderDocument() created new network decoration type (' + id + ')') }
        }

        let ipSubnetDecorationType = (id in ipSubnetDecorationTypes) ? ipSubnetDecorationTypes[id] : null
        if ((ipSubnetDecorationType === null) || configurationUpdate) {
            ...
            ipSubnetDecorationType = vscode.window.createTextEditorDecorationType({ color: themeSubnet })
            ipSubnetDecorationTypes[id] =  ipSubnetDecorationType
            if (isDebug) { console.debug(new Date().getTime() + ' renderDocument() created new subnet decoration type (' + id + ')') }
        }

        let ipIssueDecorationType = (id in ipIssueDecorationTypes) ? ipIssueDecorationTypes[id] : null
        if ((ipIssueDecorationType === null) || configurationUpdate) {
            ...
            ipIssueDecorationType = vscode.window.createTextEditorDecorationType({ color: themeIssue })
            ipIssueDecorationTypes[id] =  ipIssueDecorationType
            if (isDebug) { console.debug(new Date().getTime() + ' renderDocument() created new issue decoration type (' + id + ')') }
        }
    ...
    function updateConfiguration() {
        themeNetwork = new vscode.ThemeColor('ipaddress.network')
        themeSubnet = new vscode.ThemeColor('ipaddress.subnet')
        themeIssue = new vscode.ThemeColor('ipaddress.issue')
    }
